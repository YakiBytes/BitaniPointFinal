...
<meta charset="utf-8">
  ...
  <title>Bitani Point | Insert Akun</title>
            ...
            <div class="card">
              ...
              <div class="container mt-3">
                  ...
                  <div class="mb-3 mt-3">
                      ...
                      <input type="text" class="form-control" id="nama" placeholder="Masukan Nama" name="nama" required value="">
                    </div>
                    <div class="mb-3 mt-3">
                      <label for="username">Username</label>
                      <input type="text" class="form-control" id="username" placeholder="Masukan Username" name="username" required value="">
                    </div> 
                    <div class="mb-3 mt-3">
                      <label for="email">Email</label>
                      <input type="email" class="form-control" id="email" placeholder="Masukan Email" name="email" required value="">
                    </div>
                    <div class="mb-3 mt-3">
                    ...
                    <div class="mb-3 mt-3">
                      ...
                      <input type="password" class="form-control" id="password" placeholder="Masukan Password" name="password" required value="">
                    </div>
                    <button type="submit" class="button btn btn-primary" >Simpan</button>
                    <a href="akun.php" class="button btn btn-primary">Kembali</a>
                  </form>
                  </div>
                </div>
              <!-- /.card-body -->
