<?php
  ...
  if(isset($_POST["submit"])){
    ...
    if(mysqli_num_rows($duplicate) > 0){
      ...
      echo
      "<script> alert('Registrasi Berhasil'); document.location='loginsup.php';</script>";
    }
  }
?>
<!DOCTYPE html>
                    ...
                    <div class="col-lg-6 col-12 mx-auto custom-form donate-form">
                        <form action="" method="post" class="" role="form" autocomplete="off">
                            ...
                            <div class="row">
                                ...
                                <p>Sudah punya akun? <a href="loginsup.php">Log in</a></p>
                                <div class="col-lg-12 col-12 mt-2 buttoncenter">
                                    <input type="hidden" name="role" value="supplier">
                                    <button type="submit" name="submit" class="button" href="loginsup.php">Sign Up</button>
                                </div> 
                            </div>
                            </div>
                        </form>
