<script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            iframe.src = 'bpmaps/index.html'; 
            iframe.style.width = '100%';
            iframe.style.height = '80%';
            document.getElementById('embeddedPageContainer').appendChild(iframe);
        });
    </script>
<!DOCTYPE html>
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <main id="main">
            ...
            <div class="col-12">
              <div class="row justify-content-center">
                <div class="col-md-7 text-center hero-text">
                  <br>
                  <br>
                  <h1 data-aos="fade-up" data-aos-delay="">SIG</h1>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="container justify-content-center" style="margin-top:20px">
        <h4 style="color:#4d4b34;font-weight:bold;text-align:center;">Sebaran Lokasi Supplier Benih dan Bibit</h4>
        <div class="col-12" style="margin-top:40px">
            
        <div id="embeddedPageContainer" class="col-12 align-items-center">
              <!--<img src="img/petasig.jpg" class="img-fluid" style="margin-top:30px">-->
        </div>
        
        <div class="col-lg-12 col-lg-12" style="margin-top:40px">
                        <div class="rebox">
                            <table>
                            <div class="row" style="justify-content: center;">   
                                    <h5 style="margin-bottom:20px; text-align:center; color:#4d4b34; font-weight:bold "> Legenda </h5> </div> 
                                
                                
                                <tbody>
                                <div class="row">                                    
                                        <td style="color:#4d4b34; font-size:100%;"><img src="bpmaps/markers/benih.png" class="img-fluid" style="width: 90px;">
                                        Supplier Benih</td>                                        
                                    
                                                                     
                                        <td style="color:#4d4b34; font-size:100%;"><img src="bpmaps/markers/bibit.png" class="img-fluid" style="height: 90px;">
                                        Supplier Bibit</td>                                        
                                                                  
                                        <td style="color:#4d4b34; font-size:100%;;"><img src="bpmaps/markers/benihdanbibit.png" class="img-fluid" style="height: 90px;">
                                        Supplier Benih dan Bibit</td>                                        
      </div> 
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div style="justify-content:center; text-align: center;" >
                        <a href="supplier.php"
                      class="button">Lihat Daftar Supplier Bibit dan Benih</a></p></div></div>
      </div>
</div>
