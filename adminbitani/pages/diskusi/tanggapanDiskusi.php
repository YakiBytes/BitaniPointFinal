  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Data Tanggapan Diskusi</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../index.php">Home</a></li>
              <li class="breadcrumb-item"><a href="diskusi.php">Data Diskusi</a></li>
              <li class="breadcrumb-item active">Data Tanggapan Diskusi</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="container mt-3 d-flex justify-content-end">
                <a href="insertTanggapan.php" style="padding-right: 18px">
              ...
              <div class="card-body">
                <table id="myTabelUtama" class="table table-bordered table-hover table-striped">
                  ...
                  <?php
                      ...
                      $id= $_GET["id"];
                      $sql = "SELECT DISTINCT topik.*, diskusi.* FROM topik JOIN diskusi ON topik.blog_id = diskusi.id WHERE topik.blog_id = $id";
              ...
              <!-- 
                <a href=\"javascript:dialogHapus('deleteTanggapan.php?id=".$row["id"]."','".$row["description"]."')\" class=\"btn btn-info btn-sm\"><i id=\"ikon\" class=\"fas fa-trash\"></i></a>
                <a class=\"btn btn-primary btn-sm\" href=\"updateDiskusi.php?id=".$row["blog_id"]."\"><i id=\"ikon\" class=\"fas fa-pencil-alt\"></i></a><a><a/>
                <a class=\"btn btn-primary btn-sm\" href=\"updateDiskusi.php?id=".$row["blog_id"]."\"><i id=\"ikon\" class=\"fas fa-eye\"></i></a><a><a/>/.card-body -->
            </div>
            <!-- /.card -->
          </div>
          <!-- /.col -->
