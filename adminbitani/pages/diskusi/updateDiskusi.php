<?php
  ...
  $sql = "SELECT * FROM diskusi WHERE id='".$_GET["id"]."'";
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="../diskusi/diskusi.php" class="nav-link active">
              ...
              <div class="container mt-3">
                <form action="simpanUpdate.php" method="post">
                  <div class="mb-3 mt-3">
                    ...
                    <input type="text" class="form-control" id="topik" placeholder="Masukan Topik" name="topik" value="<?php echo $row["topik"]; ?>">
                  </div>  
                  <div class="mb-3 mt-3"><label for="komentar">Komentar</label>
                      <input type="text" class="form-control" id="komentar" placeholder="Masukkan Komentar" name="komentar" value="<?php echo $row["komentar"]; ?>">
                  </div>  
