...
<head>
  ...
  <title>Bitani Point | Insert Tanggapan</title>
  <meta charset="utf-8">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Tambah Tanggapan Baru</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../index.php">Home</a></li>
              <li class="breadcrumb-item"><a href="diskusi.php">Data Diskusi</a></li>
              <li class="breadcrumb-item"><a href="diskusi.php">Data Tanggapan Diskusi</a></li>
              <li class="breadcrumb-item active">Tambah Data Tanggapan</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="container mt-3">
                  <form action="simpanInsertTanggapan.php" method="post">
                    <div class="mb-3 mt-3">
                      <label for="description">Tanggapan</label>
                      <input type="text" class="form-control" id="description" placeholder="Masukkan Tanggapan" name="description" required value="">
                    </div>   
