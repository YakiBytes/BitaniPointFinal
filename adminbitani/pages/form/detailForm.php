<?php
  ...
  $sql = "SELECT * FROM pengajuan WHERE id='".$_GET["id"]."'";
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="form.php">Pengajuan Supplier</a></li>
              <li class="breadcrumb-item active">Edit Data Pengajuan Supplier</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <form action="setujui.php" method="post" class="" role="form" autocomplete="off">
                    <div class="mb-3 mt-3">
                      <label for="jenis">Jenis Supplier</label>
                      <label for="jenis">Jenis Supplier</label>
                      <input value="<?php echo isset($row["jenis"]) ? $row["jenis"] : ''; ?>" type="text" class="form-control" id="jenis" placeholder="Masukan Jenis" name="jenis">  
                    </div>
                    <div class="mb-3 mt-3">
                    ...
                    <div class="mb-3 mt-3">
                      ...
                      <input value="<?php echo $row["lokasi"]; ?>" type="text" class="form-control" id="lokasi" placeholder="Masukan Lokasi" name="lokasi">  
                    </div>
                    <div class="mb-3 mt-3">
                    ...
                    <div class="mb-3 mt-3">
                      ...
                      <input value="<?php echo $row["gambar"]; ?>" type="text" class="form-control" id="gambar" placeholder="Masukan Gambar Produk" name="gambar">
                    </div>
                    <form action="setujui.php" method="get">
                        <input type="hidden" name="id" value="<?php echo $row["id"]; ?>">
                        <button type="submit" id="buttonsetujui" class="button btn btn-primary" style="color:#4d4b34;font-weight:bold;margin-bottom:30px;">Setujui!</button>
                        <a href="form.php" class="button btn btn-primary" style="color:#4d4b34;font-weight:bold;margin-bottom:30px;">Kembali</a>
                    </form>
