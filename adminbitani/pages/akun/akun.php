          ...
          <div class="col-12">
            <div class="card">
              <div class="container mt-3 d-flex justify-content-end">
                <a href="insertAkun.php" style="padding-right: 18px">
                    ...
                    <?php
                      ...
                      while($row = $result->fetch_assoc()) {
                          echo "<tr>
                                  ...
                                  <td>".$row["username"]."</td>
                                  <td>".$row["email"]."</td>
                                  <td class=\"project-actions text-right\"><a class=\"btn btn-primary btn-sm\" href=\"updateAkun.php?id=".$row["id"]."\"><i id=\"ikon\" class=\"fas fa-pencil-alt\"></i></a><a><a/>
                                  <a href=\"javascript:dialogHapus('deleteAkun.php?id=".$row["id"]."','".$row["username"]."')\" class=\"btn btn-info btn-sm\"><i id=\"ikon\" class=\"fas fa-trash\"></i></a></td>
                                  <td></td>
                              </tr>";  
                              $nomor++;
                      }
