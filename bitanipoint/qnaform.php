...
<head>
  ...
  <!-- logo -->
  <link href="img/logobipo.png" rel="icon" !important>
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li class="has-children">
                  ...
                  <ul class="dropdown">
                    ...
                    <li class="active"><a href="qna.php" class="nav-link">QnA</a></li>
                  </ul>
                </li>
    ...
    <main id="main">
      ...
      <section class="volunteer-section section-padding" id="section_4">
        ...
        <div class="col-lg-12 col-12">
                        ...
                        <form class="custom-form volunteer-form mb-5 mb-lg-0" action="simpanform.php" method="post">
                            <br><br>
                            <h3 style="color:#4d4b34;font-weight:bold;text-align:center;">Diskusi Seputar Bibit dan Benih</h3>
                            <br>
                    

                            <div class="col-lg-12 col-12">
                            <label for="topik" class="formbold-form-label"> Topik Diskusi </label>
                            <div>
                              <input 
                                type="text"
                                name="topik"
                            ...
                            <div class="col-lg-12 col-12">
                            <label for="komentar" class="formbold-form-label"> Pertanyaan </label>
                            <div>
                              <input 
                                type="text"
                                name="komentar"
                          ...
                          <button class="button" type="submit" name="kirim">Tambah Diskusi</button>
                          </div>
