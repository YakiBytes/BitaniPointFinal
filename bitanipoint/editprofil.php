            ...
            <div class="col-12">
              <div class="row justify-content-center">
                <div class="col-md-7 text-center hero-text">
                  <br>
                  <br>
                  <h1 data-aos="fade-up" data-aos-delay="">Edit Profil</h1>
                    ...
                    <div class="col-lg-12 col-12 mx-auto custom-form donate-form ">
                        <form action="simpanprofil.php" method="post" >
                            ...
                            <div class="col-lg-12 col-12">
                                ...
                                <div style="margin:5px">
                                    <button class="buttonhapus" href="hapusprofil.php">Hapus</button></div> 

                                <div style="margin:5px">
                                    <a href="profilpublic.php"><button class="buttonedit">Batal</button></a>
                                </div>
