    ...
    if (mysqli_num_rows($result) > 0) {
        if (password_verify($password, $row['password'])) {
            if ($row['role'] == 'supplier') {
                ...
                echo "<script>alert('Tidak Diizinkan. Halaman ini hanya dapat diakses oleh supplier.');</script>";
            }
        } else {
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12 mx-auto custom-form donate-form">
                        <form action="" method="post" class="" role="form" autocomplete="off">
                            <h3 style="color:#4d4b34;font-weight:bold;text-align:center;margin-bottom:30px">Login Supplier</h3>
                            ...
                            <div class="row">
                                ...
                                <p>Belum punya akun? <a href="signupsup.php">Sign up</a></p>
                                <div class="col-lg-12 col-12 mt-2 buttoncenter">
                                    <button type="submit" name="submit" class="button" href="pengajuan.php">Log In</button>
                                </div> 
                            </div>
                            </div>
                        </form>
