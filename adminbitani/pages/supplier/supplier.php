...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="../../index.php" class="nav-link" style="color: #678441;">Home</a>
      </li>
    </ul>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid"style= "background: #f5f7f1;">
        <div class="row">
          <div class="col-12">
            <div class="card">
                ...
                <table id="myTabelUtama" class="table table-bordered table-hover table-striped">
                  <thead>
                    <tr>
                      ...
                      <th class="none">Gambar Produk</th>
                  ...
                  <?php
                          ...
                          while($row = $result->fetch_assoc()) {
                              echo "<tr>
                                      ...
                                      <td>".$row["latitude"]."</td>
                                      <td>".$row["deskripsi"]."</td>
                                      <td><img src='../../dist/img/".$row["gambar"]."'/></td>
                                      <td class=\"project-actions text-right\"><a class=\"btn btn-primary btn-sm\" href=\"updateSupplier.php?id=".$row["id"]."\"><i class=\"fas fa-pencil-alt\"></i></a><a><a/>
                                      <a href=\"javascript:dialogHapus('deleteSupplier.php?id=".$row["id"]."','".$row["supplier"]."')\" class=\"btn btn-info btn-sm\"><i class=\"fas fa-trash\"></i></a></td>
                                      <td></td>
                                  </tr>";  
                                  $nomor++;
                          }
