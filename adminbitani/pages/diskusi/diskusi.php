        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="container mt-3 d-flex justify-content-end">
                <!-- <a href="insertDiskusi.php" style="padding-right: 18px">
                  ...
                  <?php
                      ...
                      while($row = $result->fetch_assoc()) {
                          echo "<tr>
                                  ...
                                  <td>".$row["topik"]."</td>
                                  <td>".$row["komentar"]."</td>
                                  <td class=\"project-actions text-right\"><a class=\"btn btn-primary btn-sm\" href=\"updateDiskusi.php?id=".$row["id"]."\"><i id=\"ikon\" class=\"fas fa-pencil-alt\"></i></a><a><a/>
                                  <a href=\"javascript:dialogHapus('deleteDiskusi.php?id=".$row["id"]."','".$row["topik"]."')\" class=\"btn btn-info btn-sm\"><i id=\"ikon\" class=\"fas fa-trash\"></i></a>
                                  <a class=\"btn btn-primary btn-sm\" href=\"tanggapanDiskusi.php?id=".$row["id"]."\"><i id=\"ikon\" class=\"fas fa-eye\"></i></a><a><a/></td>
                                  <td></td>
                              </tr>";  
                              $nomor++;
                      }
