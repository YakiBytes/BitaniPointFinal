...
<?php
    ...
    $query = "SELECT table_user.*, tabel_supplier.id AS supplier_id
              FROM table_user
              LEFT JOIN tabel_supplier ON table_user.email = tabel_supplier.email
            ...
            <div class="col-12">
              <div class="row justify-content-center">
                <div class="col-md-7 text-center hero-text">
                  <br>
                  <br>
                  <h1 data-aos="fade-up" data-aos-delay="">Profil Supplier</h1>
                        ...
                        <form action="" method="post" class="" role="form" autocomplete="off">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-12">
                                    <h5 style="color:#4d4b34;font-weight:bold;margin-left:-12px">Nama</h5>
                                </div>

                                <div class="col-lg-12 col-12 mt-2 f-control"><?= $profil['nama'];?>
                                </div>

                                <div class="col-lg-12 col-12">
                                    <h5 style="color:#4d4b34;font-weight:bold;margin-left:-12px">Username</h5>
                                </div>

                                <div class="col-lg-12 col-12 mt-2 f-control"><?= $profil['username'];?>
                                </div>

                                <div class="col-lg-12 col-12">
                                    <h5 style="color:#4d4b34;font-weight:bold;margin-left:-12px">Email</h5> 
                                </div>

                                <div class="col-lg-12 col-12 mt-2 f-control"><?= $profil['email'];?>
                                </div>

                                <!--<div class="col-lg-12 col-12">
                                    <h5 style="color:#4d4b34;font-weight:bold;margin-left:-12px">Password</h5>
                                </div>-->

                                
                                </div>
                              </form>
                                <div class="row col-lg-12 col-12 align-items-center">
                                <div style="margin:5px">
                                <a href='editprofilsupplier.php?id=<?php echo $profil['id']; ?>'><button class="buttonedit">Edit</button></a>
                                </div> 


                                <?php if (isset($profil['supplier_id'])) { ?>
    <div style="margin: 5px">
        <a href="editdatasupplier.php?id=<?php echo $profil['supplier_id']; ?>">
            <button class="buttonedit">Edit Data Supplier</button>
        </a>
    </div>
<?php } ?>
                                ...
                                <div style="margin:5px">
                                <a href='hapusprofil.php?id=<?php echo $profil['id']; ?>'><button class="buttonhapus">Hapus</button></a>
                                </div> 
                                </div>
