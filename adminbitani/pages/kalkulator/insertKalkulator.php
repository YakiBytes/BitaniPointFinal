...
<head>
  ...
  <title>Bitani Point | Insert Kalkulator</title>
  <meta charset="utf-8">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Tambah Data Baru Tanaman untuk Kalkulator</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../index.php">Home</a></li>
              <li class="breadcrumb-item"><a href="kalkulator.php">Data Kalkulator</a></li>
              <li class="breadcrumb-item active">Tambah Data Kalkulator</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="container mt-3">
                  <form action="simpanInsert.php" method="post">
                    <div class="mb-3 mt-3">
                      ...
                      <input type="text" class="form-control" id="tanam" placeholder="Masukan Jenis Tanaman" name="tanam">
                    </div>
                    <div class="mb-3 mt-3">
                        <label for="panjang">Jarak Tanaman</label>
                          <input type="text" class="form-control" id="panjang" placeholder="Masukan Panjang Lahan yang Baik untuk Tanaman dalam Meter" name="panjang">
                    </div> 
                    <div class="mb-3 mt-3">
                        <label for="lebar">Jarak Tanaman</label>
                          <input type="text" class="form-control" id="lebar" placeholder="Masukan Lebar Lahan yang Baik untuk Tanaman dalam Meter" name="lebar">
                    </div> 
                    <div class="mb-3 mt-3">
                        <label for="harga">Harga Bibit</label>
                          <input type="text" class="form-control" id="harga" placeholder="Masukan Harga Satuan Bibit" name="harga">
                    </div> 
