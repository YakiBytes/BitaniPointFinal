<?php
  include "../konfigurasi.php";$conn = new mysqli($servername, $username, $password, $dbname);
  ?>
<!DOCTYPE html>
<html lang="en">
<head>
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="container mt-3">
                  <form action="simpanInsert.php" method="post" class="" role="form" autocomplete="off">
                    <div class="mb-3 mt-3">
                    ...
                    <div class="mb-3 mt-3">
                      ...
                      <input type="text" class="form-control" id="supplier" placeholder="Masukan Nama" name="supplier">
                    </div>
                    <div class="mb-3 mt-3">
                    ...
                    <div class="mb-3 mt-3">
                      ...
                      <select class="form-select" id="lokasi" name="lokasi">
                        <option value="Kota">Kota Bogor</option>
                        <option value="Kabupaten">Kabupaten Bogor</option>
                      </select>   
                    </div>
                    <div class="mb-3 mt-3">
                    ...
                    <div class="mb-3 mt-3">
                      ...
                      <input type="text" class="form-control" id="kontak" placeholder="Masukan Kontak" name="kontak">
                    </div>  
                    <div class="mb-3 mt-3">
                    ...
                    <div class="mb-3 mt-3">
                      ...
                      <input type="text" class="form-control" id="latitude" placeholder="Masukan Latitude" name="latitude">
                    </div>  
                    <div class="mb-3 mt-3">
